pipeline {
    ...
    stages {
        ...
        stage('build the images') {
            steps {
                sh 'docker build -t 248375036086.dkr.ecr.us-east-1.amazonaws.com/flask-app:latest ./MySQL-and-Python/FlaskApp'
                sh 'docker build -t 248375036086.dkr.ecr.us-east-1.amazonaws.com/mysql-db:latest ./MySQL-and-Python/MySQL_Queries'
            }
        }
